...
S {}
E {}
N -20 0 20 0 { lab=bias1_input}
N 220 -410 220 -390 { lab=tank_out}
N 300 -410 300 -390 { lab=source}
C {devices/iopin.sym} -10 0 2 0 {name=p1 lab=bias1_input}
C {devices/iopin.sym} 220 -400 3 0 {name=p2 lab=tank_out}
C {devices/iopin.sym} 40 -250 2 0 {name=p3 lab=bias2}
C {devices/iopin.sym} 300 -400 3 0 {name=p4 lab=source}
C {devices/code_shown.sym} 620 -380 0 0 {name=s1 only_toplevel=false value="X0 source.t27 bias1_inputa.t0 a_85_n463.t27 bulk.t348 sky130_fd_pr__nfet_01v8_lvt ad=0p pd=0u as=0p ps=0u w=1e+06u l=150000u
